...
let user: Wallet
//Grai
let PAYMASTER_ADDRESS = "0x9702beC6668A94619a9c3cfef0e220512FbEEfbd"
let ERC20Address: Address = "0x3355df6D4c9C3035724Fd0e3914dE96A5a83aaf4"
...
describe("ERC20PaymasterProd", function () {
	...
	it.only("Generate ERC20 withdrawal transaction data", async function () {
	...
	it("Check approval", async function () {
	...
	it("Check input data", async function () {
		const inputData =
		...
		const { token, amount, data } = ethers.utils.defaultAbiCoder.decode(["address", "uint256", "bytes"], inputData)
